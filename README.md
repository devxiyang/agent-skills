...
|---|---|---|
| [developer](./developer/SKILL.md) | Developer toolkit — git, shell, npm, jq, and docker. Common operations for version control, scripting, package management, JSON processing, and containers. | `git`, `npm`, `jq`, `docker` |
